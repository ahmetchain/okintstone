...
export default function HeroSection() {
  return (
    <main className="relative w-full h-[calc(100%-100px)] rounded-lg mb-20">
      <div className="absolute w-[calc(100%-10px)] mx-auto inset-0 bg-gradient-to-b from-black/50  to-transparent rounded-lg"></div>
      <img
        loading="lazy"
        src={Banner}
      ...
      <div className=" absolute -translate-y-1/2 top-[38%] md:top-[40%] -translate-x-1/2 left-1/2 md:w-[750px] ">
        ...
        <nav className="flex items-center justify-center gap-x-8 md:gap-x-20  md:mt-5 ">
          <a
            className=" rounded-full  text-nowrap font-semibold px-3 text-xs py-2.5 sm:px-6 sm:py-4 md:px-8 md:py-5 bg-black/50 md:font-normal tracking-tight hover:bg-black/35 text-white  md:text-xl"
            href="https://wa.me/905333709349"
            target="_blank"
          >
            Şimdi İletişime Geçin
          </a>
          <a className=" cursor-pointer rounded-full sm:px-6 font-semibold sm:py-4 text-xs md:px-8 px-3 py-2.5 md:py-5 text-nowrap bg-black/50 md:font-normal tracking-tight hover:bg-black/35 text-white md:text-xl">
